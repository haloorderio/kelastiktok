...
<a href="https://nikojulius.com/member/aff/go/muhnurulhakim?i=19" target="_blank" rel="noopener" class="bg-emerald-500 hover:bg-emerald-600 block py-3 px-4 rounded-lg w-full text-center mt-4" style="color:white;text-decoration:none" style=“background-color:red!important”>
				Daftar {{ page.title }}
</a>
