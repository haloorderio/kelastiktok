...
<a href="https://nikojulius.com/member/aff/go/muhnurulhakim?i=19" target="_blank" rel="noopener" style=“background-color:red!important” block py-3 px-4 rounded-lg w-full text-center mt-4" style="color:white;text-decoration:none">
				Daftar {{ page.title }}
</a>
